...
//	el problema de mapear el nombre del campo aquí (en el embeddable) es que podría insertarse en varias tablas
//	se debe mapear en el embedded
...
//	@Column(name = "codigo_postal")
	...
	public String toString() {
		return "[" + tipoVia + ", " + via + ", " + numero + ", " + piso + ", " + puerta + ", " + codigoPostal + ", "
				+ ciudad + ", " + provincia + "]";
	}
